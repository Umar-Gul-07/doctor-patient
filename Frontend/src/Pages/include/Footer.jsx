                        ...
                        <div className="col-xl-7 col-lg-8 col-md-12">
                            <div className="row">
                                ...
                                <div className="col-md-4 col-12 mt-4 mt-sm-0 pt-2 pt-sm-0">
                                    ...
                                    <ul className="list-unstyled footer-list mt-4">
                                        <li>
                                            <Link to="departments.html" className="text-foot">
                                                <i className="mdi mdi-chevron-right me-1" /> Eye Care
                                            </Link>
                                        </li>
                                        <li>
                                            <Link to="departments.html" className="text-foot">
                                                <i className="mdi mdi-chevron-right me-1" /> Psychotherapy
                                            </Link>
                                        </li>
                                        <li>
                                            <Link to="departments.html" className="text-foot">
                                                <i className="mdi mdi-chevron-right me-1" /> Dental Care
                                            </Link>
                                        </li>
                                        <li>
                                            <Link to="departments.html" className="text-foot">
                                                <i className="mdi mdi-chevron-right me-1" /> Orthopedic
                                            </Link>
                                        </li>
                                        <li>
                                            <Link to="departments.html" className="text-foot">
                                                <i className="mdi mdi-chevron-right me-1" /> Cardiology
                                            </Link>
                                        </li>
                                        <li>
                                            <Link to="departments.html" className="text-foot">
                                                <i className="mdi mdi-chevron-right me-1" /> Gynecology
                                            </Link>
                                        </li>
                                        <li>
                                            <Link to="departments.html" className="text-foot">
                                                <i className="mdi mdi-chevron-right me-1" /> Neurology
                                            </Link>
                                        </li>
                                    </ul>
                                </div>
